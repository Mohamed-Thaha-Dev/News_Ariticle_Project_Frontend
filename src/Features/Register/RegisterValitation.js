...
export let RegisterVal = Yup.object().shape({
    ...
    password : Yup.string().min(6,"Password must be at least 6 characters / கடவுச்சொல் குறைந்தது 6 எழுத்துகள் இருக்க வேண்டும்").required("Password is required / கடவுச்சொல் கட்டாயம்"),
